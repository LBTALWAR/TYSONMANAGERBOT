...
`◇───────────────◇`
👨‍💻 **Generated By** : [Alone God](https://t.me/AloneGodRoBot)
🙋‍♂️ **Requestor** : {}
⚡️ **Powered By **  : [Zex](https://t.me/ZexNetwork)
`◇───────────────◇️ ` 
    """
JOIN_ASAP = f" **🚫 Access Denied**\n\n You Must Join [Zex](https://t.me/ZexNetwork)To Use Me. So, Please Join it & Try Again." 
FSUBB = InlineKeyboardMarkup( 
           [[ 
               InlineKeyboardButton(text="Network", url=f"https://t.me/ZexNetwork") 
           ]] 
)
